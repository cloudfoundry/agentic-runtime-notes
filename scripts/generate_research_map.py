...
<script>const plots={data};const primitiveMemberships={membership_data};const useCaseMemberships={use_case_membership_data};const dialog=document.querySelector('#detail'),content=document.querySelector('#content'),filterStatus=document.querySelector('#filter-status');let selectedUseCase=null,selectedPrimitive=null;document.querySelector('.close').onclick=()=>dialog.close();
